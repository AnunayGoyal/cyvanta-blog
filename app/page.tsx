  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-12 w-full max-w-[1600px] mx-auto overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 w-full pb-10 items-stretch">
        ...
        {/* CARD 1: SIGNALS */}
        <Link href="/blog/ai-driven-ddos" className="group relative border border-white/10 bg-[#0a0a0a] p-8 rounded-sm hover:border-emerald-500/50 transition-all duration-300 flex flex-col h-full min-h-[280px] overflow-hidden">
          ...
          {/* Spacer - Pushes content down by a fixed amount (mt-16) to align titles */}
        ...
        {/* CARD 2: VECTORS */}
        <Link href="#" className="group relative border border-white/10 bg-[#0a0a0a] p-8 rounded-sm hover:border-primary/50 transition-all duration-300 flex flex-col h-full min-h-[280px] overflow-hidden">
        ...
        {/* CARD 3: PROTOCOLS */}
        <Link href="#" className="group relative border border-white/10 bg-[#0a0a0a] p-8 rounded-sm hover:border-cyan-500/50 transition-all duration-300 flex flex-col h-full min-h-[280px] overflow-hidden">
