...
const getTagColor = (tag: string) => {
  ...
  if (t.includes("research")) return "text-green-400 border-green-400/20 bg-green-400/5";
  if (t.includes("red team")) return "text-red-500 border-red-500/20 bg-red-500/5";
  if (t.includes("defense")) return "text-blue-400 border-blue-400/20 bg-blue-400/5";
  if (t.includes("ai")) return "text-purple-400 border-purple-400/20 bg-purple-400/5";
  if (t.includes("network")) return "text-cyan-400 border-cyan-400/20 bg-cyan-400/5";
             ...
             <div className="not-prose my-8">
               <div className="bg-[#0D0D0D] border border-white/10 rounded-md overflow-hidden shadow-2xl">
                 ...
                 <div className="p-6 overflow-x-auto bg-[#0a0a0a]">
                   {/* NOTE: The code inside <pre> is pulled to the far left to 
                      prevent 'whitespace-pre' from adding extra indentation.
                   */}
